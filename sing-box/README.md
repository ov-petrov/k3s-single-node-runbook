...
- [Подписка провайдера](../docs/sing-box-subscription.md): защищённое хранение URL,
  получение VLESS-кандидатов и безопасное обновление пула;
- [Управление TUN на cloud-ru](../docs/sing-box-host-proxy.md).

Исходные скрипты контроллера, проверки пула и импорта были перенесены с сервера
и затем доработаны для безопасного обновления подписки. Реальные конфиги подключений,
